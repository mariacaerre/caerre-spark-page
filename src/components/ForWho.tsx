...
const ForWho = () => {
  const benefits = [
    ...
    "Está cansada de soluções genéricas e quer aplicar marketing com propósito",
        ...
        <div className="grid gap-6 text-left max-w-3xl mx-auto">
          {benefits.map((benefit, index) => (
            <div key={index} className="flex items-start space-x-4 p-4 rounded-lg hover:bg-gray-50 transition-colors">
              <div className="flex-shrink-0 w-6 h-6 bg-caerre-accent rounded-full flex items-center justify-center mt-1">
